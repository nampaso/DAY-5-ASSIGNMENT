# Technical Writing Lab: User Manual, API Reference, and Critique
...
1. **Log in to GitHub and navigate to the creation page.**
   * Open your web browser, navigate to [github.com](https://github.com), log in to your account, and click the **`+`** icon in the upper-right corner of the top navigation bar, then select **New repository**.
...
4. **Copy your remote repository URL.**
   ...
   * *Expected Result:* The URL string (e.g., `https://github.com/your-username/my-first-repo.git`) is copied to your operating system's clipboard.
...
7. **Stage all files for tracking.**
   ...
   * *Expected Result:* Git stages all files in your current directory without displaying error messages. You can verify this by typing `git status` to see your files listed in green under "Changes to be committed".
...
10. **Link your local repository to GitHub.**
    * Type `git remote add origin ` into the terminal prompt, paste the URL you copied in Step 4, and press **Enter**.
...
>   3. A highlighted banner over the section titled **"…or push an existing repository from the command line"** to guide students who are connecting a local folder.
